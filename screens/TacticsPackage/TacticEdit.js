...
const TacticEdit = ({ navigation }) => {
  ...
  useEffect(() => {
    const fetchTacticData = async () => {
      try {
        await handleTacticCall(tacticId);
      } catch (error) {
  ...
  const handleTacticCall = async (tacticId) => {
    const data = await GetTatics(tacticId);
    handleChangeMainText(data.data.result.subTactic);
    handleChangeSubText(data.data.result.tacticDetails);
    setTacticNameValue(data.data.result.tacticName);
    setMainFormationValue(data.data.result.mainFormation);
    ...
    setPositionDetailsValue1(
      data.data.result.positionDetail[0].positionDescription
    );
    setPositionDetailsValue2(
      data.data.result.positionDetail[1].positionDescription
    );
    setPositionDetailsValue3(
      data.data.result.positionDetail[2].positionDescription
    );
    setPositionDetailsValue4(
      data.data.result.positionDetail[3].positionDescription
    );
    setPositionDetailsValue5(
      data.data.result.positionDetail[4].positionDescription
    );
    setPositionDetailsValue6(
      data.data.result.positionDetail[5].positionDescription
    );
    setPositionDetailsValue7(
      data.data.result.positionDetail[6].positionDescription
    );
    setPositionDetailsValue8(
      data.data.result.positionDetail[7].positionDescription
    );
    setPositionDetailsValue9(
      data.data.result.positionDetail[8].positionDescription
    );
    setPositionDetailsValue10(
      data.data.result.positionDetail[9].positionDescription
    );
    setPositionDetailsValue11(
  ...
  return (
    <Container>
      ...
      <ViewForTacticBoard>
        <ViewForDropdown>
          <TacticName value={MainFormationValue}></TacticName>
        </ViewForDropdown>
        <ViewForBoard>
